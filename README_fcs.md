...
```
- 注意：修改 source $HOME/unitree/unitree_ros2/cyclonedds_ws/install/setup.bash，改为unitree_ros2的正确路径
```bash
source ~/unitree/unitree_ros2/setup_default.sh # 不指定网卡
```
